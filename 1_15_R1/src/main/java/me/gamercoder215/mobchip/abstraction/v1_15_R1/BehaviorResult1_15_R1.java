...
public final class BehaviorResult1_15_R1 extends BehaviorResult {
    ...
    public BehaviorResult1_15_R1(Behavior<? super EntityLiving> b, EntityInsentient mob) {
        this.b = b;
        this.mob = mob;
        this.l = ChipUtil1_15_R1.toNMS(Bukkit.getWorld(mob.world.getWorld().getUID()));
    ...
    public @NotNull Status getStatus() {
        return ChipUtil1_15_R1.fromNMS(b.a());
    }
