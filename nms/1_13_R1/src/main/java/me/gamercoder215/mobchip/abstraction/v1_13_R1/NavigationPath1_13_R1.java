...
final class NavigationPath1_13_R1 implements NavigationPath {
    private String name;
    private final Mob m;
    private final PathEntity handle;
    private double speedMod;

    public NavigationPath1_13_R1(@NotNull PathEntity nms, @NotNull Mob m, double speedMod) {
        this.m = m;
