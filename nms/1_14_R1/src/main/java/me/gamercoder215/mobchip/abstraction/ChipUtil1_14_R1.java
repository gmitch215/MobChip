...
import me.gamercoder215.mobchip.abstraction.v1_14_R1.*;
import me.gamercoder215.mobchip.abstraction.v1_14_R1.recreation.AnimalPanic1_14_R1;
...
public class ChipUtil1_14_R1 implements ChipUtil {
    ...
    public static net.minecraft.server.v1_14_R1.ItemStack toNMS(org.bukkit.inventory.ItemStack i) {
    ...
    private static final Map<String, BiFunction<EntityInsentient, Object[], BehaviorResult>> ALTERNATE_BEHAVIOR_PATTERNS = ImmutableMap.<String, BiFunction<EntityInsentient, Object[], BehaviorResult>>builder()
            .put("AnimalPanic", (m, args) -> new BehaviorResult1_14_R1(new AnimalPanic1_14_R1((float) args[0]), m))
            .build();
    ...
    public me.gamercoder215.mobchip.ai.memories.MemoryStatus getMemoryStatus(Mob mob, Memory<?> m) {
        ...
        if (nms.getBehaviorController().a(nmsM, net.minecraft.server.v1_14_R1.MemoryStatus.VALUE_PRESENT)) return me.gamercoder215.mobchip.ai.memories.MemoryStatus.PRESENT;
        if (nms.getBehaviorController().a(nmsM, net.minecraft.server.v1_14_R1.MemoryStatus.VALUE_ABSENT)) return me.gamercoder215.mobchip.ai.memories.MemoryStatus.ABSENT;
    ...
    public static net.minecraft.server.v1_14_R1.Entity toNMS(Entity en) {
    ...
    public static <T extends Entity> Class<? extends T> fromNMS(Class<? extends net.minecraft.server.v1_14_R1.Entity> clazz, Class<T> cast) {
        try {
    ...
    public static org.bukkit.World fromNMS(net.minecraft.server.v1_14_R1.World l) { return l.getWorld(); }
    ...
    public static BlockPosition getPosWithBlock(net.minecraft.server.v1_14_R1.Block block, BlockPosition bp, IBlockAccess g) {
    ...
    @NotNull
    private AttributeInstance1_14_R1 getOrCreateInstance(Mob m, Attribute a) {
        EntityInsentient nms = toNMS(m);
        AttributeMapBase map = nms.getAttributeMap();
        AttributeBase nmsA = (AttributeBase) CUSTOM_ATTRIBUTE_MAP.get(a.getKey());

        net.minecraft.server.v1_14_R1.AttributeInstance handle = toNMS(m).getAttributeInstance(nmsA);
        if (handle != null) return new AttributeInstance1_14_R1(a, handle);

        try {
            Field attributesF = AttributeMapBase.class.getDeclaredField("b");
            attributesF.setAccessible(true);
            Map<AttributeBase, net.minecraft.server.v1_14_R1.AttributeInstance> attributes = (Map<AttributeBase, net.minecraft.server.v1_14_R1.AttributeInstance>) attributesF.get(map);

            handle = new AttributeModifiable(map, nmsA);
            attributes.put(nmsA, handle);

            return new AttributeInstance1_14_R1(a, handle);
    ...
    public static Entity fromNMS(net.minecraft.server.v1_14_R1.Entity en) {
        return en.getBukkitEntity();
    }

    public static me.gamercoder215.mobchip.combat.CombatEntry fromNMS(Mob m, net.minecraft.server.v1_14_R1.CombatEntry en) {
        int time = 0;
        float health = 0;
    ...
    public static net.minecraft.server.v1_14_R1.CombatEntry toNMS(me.gamercoder215.mobchip.combat.CombatEntry en) {
