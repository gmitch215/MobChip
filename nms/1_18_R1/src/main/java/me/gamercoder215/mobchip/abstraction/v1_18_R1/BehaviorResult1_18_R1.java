...
final class BehaviorResult1_18_R1 extends BehaviorResult {
    ...
    public BehaviorResult1_18_R1(Behavior<? super LivingEntity> b, net.minecraft.world.entity.Mob mob) {
        this.b = b;
        this.mob = mob;
        this.l = ChipUtil1_18_R1.toNMS(Bukkit.getWorld(mob.level.getWorld().getUID()));
    ...
    public @NotNull Status getStatus() {
        return ChipUtil1_18_R1.fromNMS(b.getStatus());
    }
