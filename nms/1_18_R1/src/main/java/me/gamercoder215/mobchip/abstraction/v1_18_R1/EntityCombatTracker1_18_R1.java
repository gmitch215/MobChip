...
public class EntityCombatTracker1_18_R1 implements EntityCombatTracker {
    ...
    public EntityCombatTracker1_18_R1(Mob m) {
        this.m = m;
        this.handle = ChipUtil1_18_R1.toNMS(m).getCombatTracker();
    }
    ...
    public @Nullable CombatEntry getLatestEntry() {
        return handle.getLastEntry() == null ? null : ChipUtil1_18_R1.fromNMS(m, handle.getLastEntry());
    }
