...
final class EntityNavigation1_16_R2 implements EntityNavigation {
    ...
    public EntityNavigation1_16_R2(Mob m) {
        this.handle = ChipUtil1_16_R2.toNMS(m).getNavigation();
    ...
    public NavigationPath buildPath() {
        return new NavigationPath1_16_R2(new PathEntity(toNodes(), finalPos, true), m, speedMod);
    }
    @Override
