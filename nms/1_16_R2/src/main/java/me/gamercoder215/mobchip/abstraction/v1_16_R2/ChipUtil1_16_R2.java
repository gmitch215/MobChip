...
final class ChipUtil1_16_R2 implements ChipUtil {
    ...
    public void addCustomPathfinder(CustomPathfinder p, int priority, boolean target) {
        ...
        Set<PathfinderGoal.Type> nms = ChipUtil1_16_R2.getFlags(g);
    ...
    public me.gamercoder215.mobchip.ai.memories.MemoryStatus getMemoryStatus(Mob mob, Memory<?> m) {
        ...
        if (nms.getBehaviorController().a(nmsM, net.minecraft.server.v1_16_R2.MemoryStatus.VALUE_PRESENT)) return me.gamercoder215.mobchip.ai.memories.MemoryStatus.PRESENT;
        if (nms.getBehaviorController().a(nmsM, net.minecraft.server.v1_16_R2.MemoryStatus.VALUE_ABSENT)) return me.gamercoder215.mobchip.ai.memories.MemoryStatus.ABSENT;
