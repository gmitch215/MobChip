...
final class EntityNavigation1_15_R1 implements EntityNavigation {
    ...
    public EntityNavigation1_15_R1(Mob m) {
        this.handle = ChipUtil1_15_R1.toNMS(m).getNavigation();
    ...
    public NavigationPath buildPath() {
        return new NavigationPath1_15_R1(new PathEntity(toNodes(), finalPos, true), m, speedMod);
    }
    @Override
