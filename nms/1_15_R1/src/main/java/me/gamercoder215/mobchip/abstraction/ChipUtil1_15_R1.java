...
import me.gamercoder215.mobchip.abstraction.v1_15_R1.recreation.AnimalPanic1_15_R1;
...
public class ChipUtil1_15_R1 implements ChipUtil {
    ...
    public static org.bukkit.inventory.ItemStack fromNMS(net.minecraft.server.v1_15_R1.ItemStack item) { return CraftItemStack.asBukkitCopy(item); }
    ...
    public static net.minecraft.server.v1_15_R1.ItemStack toNMS(org.bukkit.inventory.ItemStack i) {
    ...
    private static final Map<String, BiFunction<EntityInsentient, Object[], BehaviorResult>> ALTERNATE_BEHAVIOR_PATTERNS = ImmutableMap.<String, BiFunction<EntityInsentient, Object[], BehaviorResult>>builder()
            .put("AnimalPanic", (m, args) -> new BehaviorResult1_15_R1(new AnimalPanic1_15_R1((float) args[0]), m))
            .build();
    ...
    public me.gamercoder215.mobchip.ai.memories.MemoryStatus getMemoryStatus(Mob mob, Memory<?> m) {
        ...
        if (nms.getBehaviorController().a(nmsM, net.minecraft.server.v1_15_R1.MemoryStatus.VALUE_PRESENT)) return me.gamercoder215.mobchip.ai.memories.MemoryStatus.PRESENT;
        if (nms.getBehaviorController().a(nmsM, net.minecraft.server.v1_15_R1.MemoryStatus.VALUE_ABSENT)) return me.gamercoder215.mobchip.ai.memories.MemoryStatus.ABSENT;
    ...
    public static net.minecraft.server.v1_15_R1.Entity toNMS(Entity en) {
    ...
    public static <T extends Entity> Class<? extends T> fromNMS(Class<? extends net.minecraft.server.v1_15_R1.Entity> clazz, Class<T> cast) {
        try {
    ...
    public static org.bukkit.World fromNMS(net.minecraft.server.v1_15_R1.World l) { return l.getWorld(); }
    ...
    public static BlockPosition getPosWithBlock(net.minecraft.server.v1_15_R1.Block block, BlockPosition bp, IBlockAccess g) {
    ...
    public static Entity fromNMS(net.minecraft.server.v1_15_R1.Entity en) {
        return en.getBukkitEntity();
    }

    public static me.gamercoder215.mobchip.combat.CombatEntry fromNMS(Mob m, net.minecraft.server.v1_15_R1.CombatEntry en) {
        int time = 0;
        float health = 0;
    ...
    public static net.minecraft.server.v1_15_R1.CombatEntry toNMS(me.gamercoder215.mobchip.combat.CombatEntry en) {
    ...
    public static Sensor<?> toNMS(me.gamercoder215.mobchip.ai.sensing.Sensor<?> s) {
        if (s instanceof SensorDefault1_15_R1) return ((SensorDefault1_15_R1) s).getHandle();
        return new Sensor1_15_R1(s);
    }
    ...
    public static me.gamercoder215.mobchip.ai.sensing.Sensor<?> fromNMS(Sensor<?> type) {
        if (type instanceof Sensor1_15_R1) return ((Sensor1_15_R1) type).getSensor();
        return new SensorDefault1_15_R1(type);
    }
    ...
    public me.gamercoder215.mobchip.ai.sensing.EntitySenses getSenses(Mob m) {
        return new EntitySenses1_15_R1(m);
    }
