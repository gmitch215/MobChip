...
public class EntityCombatTracker1_15_R1 implements EntityCombatTracker {

    private final CombatTracker handle;
    private final Mob m;

    public EntityCombatTracker1_15_R1(Mob m) {
        this.m = m;
        this.handle = ChipUtil1_15_R1.toNMS(m).getCombatTracker();
    }
    ...
    public boolean hasLastDamageCancelled() {
        return ChipUtil1_15_R1.toNMS(m).forceExplosionKnockback;
    }
}
