...
import static org.bukkit.craftbukkit.v1_20_R4.attribute.CraftAttributeInstance.convert;
...
final class AttributeInstance1_20_R4 implements AttributeInstance {
    ...
    public AttributeInstance1_20_R4(Attribute a, net.minecraft.world.entity.ai.attributes.AttributeInstance handle) {
        this.a = a;
        this.handle = handle;
    }
