...
public final class DragonPhase1_18_R2 implements DragonPhase {

    private final EnderDragon dragon;
    private final DragonPhaseInstance handle;

    public DragonPhase1_18_R2(EnderDragon dragon, DragonPhaseInstance handle) {
        this.dragon = dragon;
        this.handle = handle;
    }
    ...
    public @NotNull Location getTargetLocation() {
        return ChipUtil1_18_R2.fromNMS(handle.getFlyTargetLocation(), dragon.getWorld());
    }
