...
final class EntityCombatTracker1_13_R2 implements EntityCombatTracker {

    private final CombatTracker handle;
    private final Mob m;

    public EntityCombatTracker1_13_R2(Mob m) {
        this.m = m;
        this.handle = ChipUtil1_13_R2.toNMS(m).getCombatTracker();
    }
    ...
    public boolean hasLastDamageCancelled() {
        return ChipUtil1_13_R2.toNMS(m).forceExplosionKnockback;
    }
}
