...
final class EntityBody1_16_R1 implements EntityBody {
    ...
    public InteractionResult interact(@NotNull Player p, @Nullable InteractionHand hand) {
        ...
        switch (nmsMob.a(ChipUtil1_16_R1.toNMS(p), h)) {
            case SUCCESS:
    ...
    public void setBodyRotation(float rotation) {
        nmsMob.aH = EntityBody.normalizeRotation(rotation);
    }
    ...
    public void setHeadRotation(float rotation) {
        nmsMob.aJ = EntityBody.normalizeRotation(rotation);
    }
    ...
    public void playAnimation(@NotNull EntityAnimation anim) {
        switch (anim) {
            ...
            case CRITICAL_DAMAGE: {
                ...
                for (Player p : ChipUtil1_16_R1.fromNMS(nmsMob).getWorld().getPlayers())
                    ChipUtil1_16_R1.toNMS(p).playerConnection.sendPacket(pkt);
                break;
            }
    ...
    public boolean isInvulnerableTo(EntityDamageEvent.@Nullable DamageCause cause) {
        return nmsMob.isInvulnerable(ChipUtil1_16_R1.toNMS(cause));
    }
    ...
    public boolean isPushableBy(@Nullable Entity entity) {
        return IEntitySelector.a(ChipUtil1_16_R1.toNMS(entity)).test(ChipUtil1_16_R1.toNMS(entity));
    }
    ...
    public void eat(@NotNull ItemStack item) {
        nmsMob.a(ChipUtil1_16_R1.toNMS(m.getWorld()), ChipUtil1_16_R1.toNMS(item));
    }
