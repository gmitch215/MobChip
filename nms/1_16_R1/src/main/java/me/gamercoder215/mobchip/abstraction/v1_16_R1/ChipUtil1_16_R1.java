...
final class ChipUtil1_16_R1 implements ChipUtil {

    public static org.bukkit.inventory.ItemStack fromNMS(net.minecraft.server.v1_16_R1.ItemStack item) { return CraftItemStack.asBukkitCopy(item); }
    ...
    public void addCustomPathfinder(CustomPathfinder p, int priority, boolean target) {
        ...
        Set<PathfinderGoal.Type> nms = ChipUtil1_16_R1.getFlags(g);
    ...
    public static net.minecraft.server.v1_16_R1.ItemStack toNMS(org.bukkit.inventory.ItemStack i) {
    ...
    public static net.minecraft.server.v1_16_R1.Entity toNMS(Entity en) {
    ...
    public static <T extends Entity> Class<? extends T> fromNMS(Class<? extends net.minecraft.server.v1_16_R1.Entity> clazz, Class<T> cast) {
        try {
    ...
    public static org.bukkit.World fromNMS(net.minecraft.server.v1_16_R1.World l) { return l.getWorld(); }
    ...
    public static BlockPosition getPosWithBlock(net.minecraft.server.v1_16_R1.Block block, BlockPosition bp, IBlockAccess g) {
    ...
    @NotNull
    private AttributeInstance1_16_R1 getOrCreateInstance(Mob m, Attribute a) {
        EntityInsentient nms = toNMS(m);
        ...
        if (handle != null) return new AttributeInstance1_16_R1(a, handle);
        ...
        try {
            ...
            return new AttributeInstance1_16_R1(a, handle);
        } catch (ReflectiveOperationException e) {
            ChipUtil.printStackTrace(e);
        }
    ...
    public static Entity fromNMS(net.minecraft.server.v1_16_R1.Entity en) {
        return en.getBukkitEntity();
    }

    public static me.gamercoder215.mobchip.combat.CombatEntry fromNMS(Mob m, net.minecraft.server.v1_16_R1.CombatEntry en) {
        int time = 0;
        float health = 0;
    ...
    public static net.minecraft.server.v1_16_R1.CombatEntry toNMS(me.gamercoder215.mobchip.combat.CombatEntry en) {
    ...
    public static Sensor<?> toNMS(me.gamercoder215.mobchip.ai.sensing.Sensor<?> s) {
        if (s instanceof SensorDefault1_16_R1) return ((SensorDefault1_16_R1) s).getHandle();
        return new Sensor1_16_R1(s);
    }
    ...
    public static me.gamercoder215.mobchip.ai.sensing.Sensor<?> fromNMS(Sensor<?> type) {
        if (type instanceof Sensor1_16_R1) return ((Sensor1_16_R1) type).getSensor();
        return new SensorDefault1_16_R1(type);
    }
    ...
    public void registerSensor(me.gamercoder215.mobchip.ai.sensing.Sensor<?> s) {
        DedicatedServer server = ((CraftServer) Bukkit.getServer()).getServer();
        if (!server.f.a(IRegistry.X).isPresent()) return;
        IRegistryWritable<SensorType<?>> writable = server.f.a(IRegistry.X).get();
        ResourceKey<SensorType<?>> nmsKey = ResourceKey.a(IRegistry.X, toNMS(s.getKey()));
        writable.a(nmsKey, toNMSType(s));
    }

    @Override
    public boolean existsSensor(NamespacedKey key) {
        return IRegistry.SENSOR_TYPE.e()
    ...
    public me.gamercoder215.mobchip.ai.sensing.EntitySenses getSenses(Mob m) {
        return new EntitySenses1_16_R1(m);
    }
