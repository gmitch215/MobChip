...
final class AnimalPanic1_16_R1 extends Behavior<EntityCreature> {

    private final float speedMultiplier;

    public AnimalPanic1_16_R1(float speedMod) {
        super(ImmutableMap.of(MemoryModuleType.HURT_BY, MemoryStatus.VALUE_PRESENT), 100, 120);
        this.speedMultiplier = speedMod;
    }

    protected boolean b(WorldServer var0, EntityCreature var1, long var2) { return true; }
    ...
    private static boolean isRestricted(EntityCreature c, int var1) {
        return c.eA() && c.ex().a(c.getPositionVector(), (double) (c.ey() + (float) var1) + 1.0D);
    }
