...
import static org.bukkit.craftbukkit.v1_20_R1.attribute.CraftAttributeInstance.convert;
...
final class AttributeInstance1_20_R1 implements AttributeInstance {
    ...
    public AttributeInstance1_20_R1(Attribute a, net.minecraft.world.entity.ai.attributes.AttributeInstance handle) {
        this.a = a;
        this.handle = handle;
    }
