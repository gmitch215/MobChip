...
final class NavigationPath1_16_R3 implements NavigationPath {
    private String name;
    private final Mob m;
    private final PathEntity handle;
    private double speedMod;

    public NavigationPath1_16_R3(@NotNull PathEntity nms, @NotNull Mob m, double speedMod) {
        this.m = m;
    ...
    public void advance() {
        ...
        new EntityController1_16_R3(m).moveTo(n.a, n.b, n.c, speedMod);
