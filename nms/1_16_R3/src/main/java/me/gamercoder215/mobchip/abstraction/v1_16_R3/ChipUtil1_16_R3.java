...
final class ChipUtil1_16_R3 implements ChipUtil {

    public static ItemStack fromNMS(net.minecraft.server.v1_16_R3.ItemStack item) { return CraftItemStack.asBukkitCopy(item); }
    ...
    public void addCustomPathfinder(CustomPathfinder p, int priority, boolean target) {
        ...
        Set<PathfinderGoal.Type> nms = ChipUtil1_16_R3.getFlags(g);
    ...
    public static net.minecraft.server.v1_16_R3.ItemStack toNMS(ItemStack i) {
    ...
    public static PathfinderGoal toNMS(Pathfinder b) {
        ...
        switch (name) {
            ...
            default: {
                if (b instanceof CustomPathfinder) return custom((CustomPathfinder) b);
                else return null;
            }
        }
    }
    ...
    public BehaviorResult runBehavior(Mob m, String behaviorName, String packageName, Object... args) {
        ...
        try {
            Class<?> bClass = Class.forName("net.minecraft.server.v1_16_R3." + behaviorName);
    ...
    public me.gamercoder215.mobchip.ai.memories.MemoryStatus getMemoryStatus(Mob mob, Memory<?> m) {
        ...
        if (nms.getBehaviorController().a(nmsM, net.minecraft.server.v1_16_R3.MemoryStatus.VALUE_PRESENT)) return me.gamercoder215.mobchip.ai.memories.MemoryStatus.PRESENT;
        if (nms.getBehaviorController().a(nmsM, net.minecraft.server.v1_16_R3.MemoryStatus.VALUE_ABSENT)) return me.gamercoder215.mobchip.ai.memories.MemoryStatus.ABSENT;
    ...
    public static net.minecraft.server.v1_16_R3.Entity toNMS(Entity en) {
    ...
    public static <T extends Entity> Class<? extends T> fromNMS(Class<? extends net.minecraft.server.v1_16_R3.Entity> clazz, Class<T> cast) {
        try {
    ...
    public static World fromNMS(net.minecraft.server.v1_16_R3.World l) { return l.getWorld(); }
    ...
    public static PathfinderGoal custom(CustomPathfinder p) {
        CustomGoal1_16_R3 g = new CustomGoal1_16_R3(p);
        EnumSet<PathfinderGoal.Type> flags = EnumSet.noneOf(PathfinderGoal.Type.class);
        Arrays.stream(p.getFlags()).map(ChipUtil1_16_R3::toNMS).forEach(flags::add);
        g.a(flags);
        return g;
    }

    public static BlockPosition getPosWithBlock(net.minecraft.server.v1_16_R3.Block block, BlockPosition bp, IBlockAccess g) {
    ...
    public static Entity fromNMS(net.minecraft.server.v1_16_R3.Entity en) {
        return en.getBukkitEntity();
    }

    public static CombatEntry fromNMS(Mob m, net.minecraft.server.v1_16_R3.CombatEntry en) {
        int time = 0;
        float health = 0;

        try {
            Field timeF = net.minecraft.server.v1_16_R3.CombatEntry.class.getDeclaredField("b");
            timeF.setAccessible(true);
            time = timeF.getInt(en);

            Field healthF = net.minecraft.server.v1_16_R3.CombatEntry.class.getDeclaredField("d");
    ...
    public static net.minecraft.server.v1_16_R3.CombatEntry toNMS(me.gamercoder215.mobchip.combat.CombatEntry en) {
        return new net.minecraft.server.v1_16_R3.CombatEntry(toNMS(en.getCause()), en.getCombatTime(), en.getHealthBeforeDamage(), en.getDamage(), en.getLocation().getKey().getKey(), en.getFallDistance());
    }

    @Override
    public EntityCombatTracker getCombatTracker(Mob m) { return new EntityCombatTracker1_16_R3(m); }
    ...
    public DragonPhase fromBukkit(EnderDragon d, EnderDragon.Phase phase) {
        ...
        return new DragonPhase1_16_R3(d, i);
    }

    @Override
    public DragonPhase getCurrentPhase(EnderDragon dragon) {
        return new DragonPhase1_16_R3(dragon, toNMS(dragon).getDragonControllerManager().a());
    }
    ...
    public static Sensor<?> toNMS(me.gamercoder215.mobchip.ai.sensing.Sensor<?> s) {
        if (s instanceof SensorDefault1_16_R3) return ((SensorDefault1_16_R3) s).getHandle();
        return new Sensor1_16_R3(s);
    }
    ...
    public static me.gamercoder215.mobchip.ai.sensing.Sensor<?> fromNMS(Sensor<?> type) {
        if (type instanceof Sensor1_16_R3) return ((Sensor1_16_R3) type).getSensor();
        return new SensorDefault1_16_R3(type);
    }
    ...
    public EntitySenses getSenses(Mob m) {
        return new EntitySenses1_16_R3(m);
    }
