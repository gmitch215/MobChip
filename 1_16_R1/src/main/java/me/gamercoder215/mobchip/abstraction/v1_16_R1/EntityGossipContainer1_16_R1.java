...
public class EntityGossipContainer1_16_R1 implements EntityGossipContainer {
    private final Reputation handle;
    private final Villager entity;

    public EntityGossipContainer1_16_R1(Villager v) {
        this.entity = v;
    ...
    public int getReputation(@NotNull Entity en, @Nullable GossipType... types) throws IllegalArgumentException {
        return handle.a(en.getUniqueId(), g -> Arrays.asList(types).contains(ChipUtil1_16_R1.fromNMS(g)));
    }

    @Override
    public void put(@NotNull Entity en, @NotNull GossipType type, int maxCap) throws IllegalArgumentException {
        handle.a(en.getUniqueId(), ChipUtil1_16_R1.toNMS(type), maxCap);
    }
    ...
    public void removeAll(@NotNull GossipType type) throws IllegalArgumentException {
        try {
            ...
            for (UUID uuid : data.keySet()) {
                ...
                m.invoke(o, ChipUtil1_16_R1.toNMS(type));
