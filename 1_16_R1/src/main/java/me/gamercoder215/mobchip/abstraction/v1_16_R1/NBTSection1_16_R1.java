...
public class NBTSection1_16_R1 implements NBTSection {
    ...
    public NBTSection1_16_R1(NBTTagCompound tag, Runnable saveFunc, String path) {
        this.tag = tag;
        this.saveFunc = saveFunc;
        this.currentPath = path;
    }

    public NBTSection1_16_R1(Mob m) {
        this.tag = new NBTTagCompound();
        this.currentPath = "";
        ChipUtil1_16_R1.toNMS(m).save(tag);
        this.saveFunc = () -> ChipUtil1_16_R1.toNMS(m).load(tag);
    }
    ...
    static Object deserialize(NBTBase v) {
        if (v instanceof NBTTagList) {
            ...
            list.stream().map(NBTSection1_16_R1::deserialize).forEach(l::add);
            return l.toArray();
        }
