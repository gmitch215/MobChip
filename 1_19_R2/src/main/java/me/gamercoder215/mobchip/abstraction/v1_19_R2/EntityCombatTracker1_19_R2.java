...
public class EntityCombatTracker1_19_R2 implements EntityCombatTracker {
    ...
    public EntityCombatTracker1_19_R2(Mob m) {
        this.m = m;
        this.handle = ChipUtil1_19_R2.toNMS(m).getCombatTracker();
    }
    ...
    public @Nullable CombatEntry getLatestEntry() {
        return handle.getLastEntry() == null ? null : ChipUtil1_19_R2.fromNMS(m, handle.getLastEntry());
    }
    ...
    public boolean hasLastDamageCancelled() {
        return ChipUtil1_19_R2.toNMS(m).lastDamageCancelled;
    }
}
