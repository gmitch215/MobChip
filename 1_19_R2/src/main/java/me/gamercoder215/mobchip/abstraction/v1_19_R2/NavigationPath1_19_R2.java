...
public final class NavigationPath1_19_R2 implements NavigationPath {
    private String name;
    private final Mob m;
    private final Path handle;

    NavigationPath1_19_R2(@NotNull Path nms, @NotNull Mob m) {
        this.m = m;
    ...
    public void advance() {
        ...
        new EntityController1_19_R2(m).moveTo(n.x, n.y, n.z);
    }
