...
public final class EntityNavigation1_19_R2 implements EntityNavigation {
    ...
    public EntityNavigation1_19_R2(Mob m) {
        this.handle = ChipUtil1_19_R2.toNMS(m).getNavigation();
    ...
    public NavigationPath buildPath() {
        return new NavigationPath1_19_R2(handle.createPath(finalPos, range, speedMod), m);
    }
