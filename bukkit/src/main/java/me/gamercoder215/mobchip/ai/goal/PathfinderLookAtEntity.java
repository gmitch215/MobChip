...
public final class PathfinderLookAtEntity<T extends LivingEntity> extends Pathfinder implements Filtering<T>, Probable, Ranged {
    ...
    public LookAtPlayerGoal getHandle() {
        return new LookAtPlayerGoal(nmsEntity, MobChipUtil.toNMSClass(filterClass).asSubclass(net.minecraft.world.entity.LivingEntity.class), lookRange, probability, false);
    }
