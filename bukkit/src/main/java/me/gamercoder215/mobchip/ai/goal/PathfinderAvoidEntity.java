...
public final class PathfinderAvoidEntity<T extends LivingEntity> extends Pathfinder implements Filtering<T>, SpeedModifier {
	...
	public AvoidEntityGoal<?> getHandle() {
		return new AvoidEntityGoal<>((PathfinderMob) nmsEntity, (Class<net.minecraft.world.entity.LivingEntity>) MobChipUtil.toNMSClass(getFilter()), maxDistance, speedModifier, sprintModifier);
	}
