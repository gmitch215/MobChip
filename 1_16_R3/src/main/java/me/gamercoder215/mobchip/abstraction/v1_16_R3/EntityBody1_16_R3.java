...
public final class EntityBody1_16_R3 implements EntityBody {
    private final EntityInsentient nmsMob;

    public EntityBody1_16_R3(Mob nmsMob) {
        this.nmsMob = ChipUtil1_16_R3.toNMS(nmsMob);
    }
    ...
    public InteractionResult interact(@NotNull Player p, @Nullable InteractionHand hand) {
        ...
        switch (nmsMob.a(ChipUtil1_16_R3.toNMS(p), h)) {
            case SUCCESS:
    ...
    public void playAnimation(@NotNull EntityAnimation anim) {
        switch (anim) {
            ...
            case CRITICAL_DAMAGE: {
                ...
                for (Player p : ChipUtil1_16_R3.fromNMS(nmsMob).getWorld().getPlayers())
                    ChipUtil1_16_R3.toNMS(p).playerConnection.sendPacket(pkt);
                break;
            }
    ...
    public boolean isInvulnerableTo(EntityDamageEvent.@Nullable DamageCause cause) {
        return nmsMob.isInvulnerable(ChipUtil1_16_R3.toNMS(cause));
    }
    ...
    public boolean isPushableBy(@Nullable Entity entity) {
        return IEntitySelector.a(ChipUtil1_16_R3.toNMS(entity)).test(ChipUtil1_16_R3.toNMS(entity));
    }
