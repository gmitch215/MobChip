...
public final class PathfinderTempt extends Pathfinder implements SpeedModifier {
    ...
    public PathfinderTempt(@NotNull TemptGoal g) {
        ...
        Ingredient i = Pathfinder.getField(g, "m", Ingredient.class);
        this.item = ChipConversions.convertType(i.itemStacks[0]);
    }
    ...
    public TemptGoal getHandle() {
        return new TemptGoal((PathfinderMob) nmsEntity, speedMod, Ingredient.of(ChipConversions.convertType(item)), false);
    }
