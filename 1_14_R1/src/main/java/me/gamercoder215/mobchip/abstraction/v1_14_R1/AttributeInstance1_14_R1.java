...
public class AttributeInstance1_14_R1 implements me.gamercoder215.mobchip.ai.attribute.AttributeInstance {

    private final net.minecraft.server.v1_14_R1.AttributeInstance handle;
    private final Attribute a;

    public AttributeInstance1_14_R1(Attribute a, net.minecraft.server.v1_14_R1.AttributeInstance handle) {
        this.a = a;
        this.handle = handle;
    }
