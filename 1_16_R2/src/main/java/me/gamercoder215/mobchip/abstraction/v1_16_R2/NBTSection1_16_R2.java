...
public class NBTSection1_16_R2 implements NBTSection {
    ...
    public NBTSection1_16_R2(NBTTagCompound tag, Runnable saveFunc, String path) {
        this.tag = tag;
        this.saveFunc = saveFunc;
        this.currentPath = path;
    }

    public NBTSection1_16_R2(Mob m) {
