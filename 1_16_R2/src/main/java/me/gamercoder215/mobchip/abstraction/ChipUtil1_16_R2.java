...
public class ChipUtil1_16_R2 implements ChipUtil {
    ...
    private static org.bukkit.inventory.ItemStack fromNMS(net.minecraft.server.v1_16_R2.ItemStack item) { return CraftItemStack.asBukkitCopy(item); }
    ...
    private static net.minecraft.server.v1_16_R2.ItemStack toNMS(org.bukkit.inventory.ItemStack i) {
    ...
    private static final class BehaviorResult1_16_R2 extends BehaviorResult {
        private final Behavior<? super EntityLiving> b;
        private final EntityInsentient mob;
        private final WorldServer l;

        private BehaviorResult1_16_R2(Behavior<? super EntityLiving> b, EntityInsentient mob) {
            this.b = b;
            this.mob = mob;
    ...
    private static final class EntityController1_16_R2 implements EntityController {
        ...
        public EntityController1_16_R2(Mob m) {
            EntityInsentient nms = toNMS(m);
    ...
    private static final class NavigationPath1_16_R2 implements NavigationPath {
        private String name;
        private final Mob m;
        private final PathEntity handle;

        NavigationPath1_16_R2(@NotNull PathEntity nms, @NotNull Mob m) {
            this.m = m;
    ...
    private static final class EntityNavigation1_16_R2 implements EntityNavigation {
        ...
        public NavigationPath buildPath() {
            return new NavigationPath1_16_R2(handle.a(finalPos, range), m);
        }
    ...
    private static final class EntityBody1_16_R2 implements EntityBody {
        private final EntityInsentient nmsMob;

        EntityBody1_16_R2(Mob nmsMob) {
    ...
    private static final class EntityScheduleManager1_16_R2 implements EntityScheduleManager {

        private final EntityInsentient nmsMob;
        private final Mob m;

        EntityScheduleManager1_16_R2(Mob m) {
            this.m = m;
            this.nmsMob = toNMS(m);
        }
        ...
        public @NotNull Set<me.gamercoder215.mobchip.ai.schedule.Activity> getActiveActivities() {
            return ChipUtil1_16_R2.getActiveActivities(m);
        }
    ...
    private static net.minecraft.server.v1_16_R2.Entity toNMS(Entity en) {
    ...
    private static <T extends Entity> Class<? extends T> fromNMS(Class<? extends net.minecraft.server.v1_16_R2.Entity> clazz, Class<T> cast) {
        try {
    ...
    private static World fromNMS(net.minecraft.server.v1_16_R2.World l) { return l.getWorld(); }
    ...
    private static BlockPosition getPosWithBlock(net.minecraft.server.v1_16_R2.Block block, BlockPosition bp, IBlockAccess g) {
    ...
    private static class Attribute1_16_R2 extends AttributeRanged implements Attribute {
        ...
        public Attribute1_16_R2(AttributeRanged a) {
        ...
        public Attribute1_16_R2(NamespacedKey key, double defaultV, double min, double max, boolean clientSide) {
    ...
    private static class AttributeInstance1_16_R2 implements AttributeInstance {

        private final AttributeModifiable handle;
        private final Attribute a;

        AttributeInstance1_16_R2(Attribute a, AttributeModifiable handle) {
            this.a = a;
            this.handle = handle;
        }
    ...
    private static class EntityGossipContainer1_16_R2 implements EntityGossipContainer {
        private final Reputation handle;

        EntityGossipContainer1_16_R2(Villager v) {
    ...
    private static Entity fromNMS(net.minecraft.server.v1_16_R2.Entity en) {
        return en.getBukkitEntity();
    }

    private static me.gamercoder215.mobchip.combat.CombatEntry fromNMS(Mob m, net.minecraft.server.v1_16_R2.CombatEntry en) {
        int time = 0;
        float health = 0;
    ...
    private static net.minecraft.server.v1_16_R2.CombatEntry toNMS(me.gamercoder215.mobchip.combat.CombatEntry en) {
    ...
    private static class EntityCombatTracker1_16_R2 implements EntityCombatTracker {

        private final CombatTracker handle;
        private final Mob m;

        EntityCombatTracker1_16_R2(Mob m) {
            this.m = m;
        ...
        public @NotNull List<me.gamercoder215.mobchip.combat.CombatEntry> getCombatEntries() {
            ...
            try {
                ...
                f.setAccessible(true);
                ((List<net.minecraft.server.v1_16_R2.CombatEntry>) f.get(handle)).stream().map(en -> fromNMS(m, en)).forEach(entries::add);
            } catch (Exception e) {
                Bukkit.getLogger().severe(e.getClass().getSimpleName());
                Bukkit.getLogger().severe(e.getMessage());
                for (StackTraceElement s : e.getStackTrace()) Bukkit.getLogger().severe(s.toString());
    ...
    private static final class DragonPhase1_16_R2 implements DragonPhase {

        private final EnderDragon dragon;
        private final IDragonController handle;

        DragonPhase1_16_R2(EnderDragon dragon, IDragonController handle) {
            this.dragon = dragon;
            this.handle = handle;
        }
    ...
    private static Object deserialize(NBTBase v) {
        if (v instanceof NBTTagList) {
            ...
            list.stream().map(ChipUtil1_16_R2::deserialize).forEach(l::add);
            return l.toArray();
        }
    ...
    private static class NBTSection1_16_R2 implements NBTSection {

        private final NBTTagCompound tag;
        private final Runnable saveFunc;

        NBTSection1_16_R2(NBTTagCompound tag, Runnable saveFunc) {
            this.tag = tag;
        ...
        public @Nullable NBTSection getSection(@Nullable String key) {
            return tag.get(key) == null ? null : new NBTSection1_16_R2(tag.getCompound(key), this::save);
        }

        @Override
        public @Nullable NBTSection getSection(@Nullable String key, @Nullable NBTSection def) {
            return tag.get(key) == null ? def : new NBTSection1_16_R2(tag.getCompound(key), this::save);
        }
    ...
    private static final class EntityNBT1_16_R2 extends NBTSection1_16_R2 implements EntityNBT {
