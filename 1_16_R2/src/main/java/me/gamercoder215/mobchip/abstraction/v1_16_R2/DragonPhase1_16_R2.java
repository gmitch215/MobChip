...
public final class DragonPhase1_16_R2 implements DragonPhase {

    private final EnderDragon dragon;
    private final IDragonController handle;

    public DragonPhase1_16_R2(EnderDragon dragon, IDragonController handle) {
        this.dragon = dragon;
        this.handle = handle;
    }
    ...
    public @NotNull Location getTargetLocation() {
        return ChipUtil1_16_R2.fromNMS(handle.g(), dragon.getWorld());
    }
