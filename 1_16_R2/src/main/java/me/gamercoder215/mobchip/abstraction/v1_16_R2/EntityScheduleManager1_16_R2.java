...
public final class EntityScheduleManager1_16_R2 implements EntityScheduleManager {

    private final EntityInsentient nmsMob;
    private final Mob m;

    public EntityScheduleManager1_16_R2(Mob m) {
        this.m = m;
    ...
    public @Nullable me.gamercoder215.mobchip.ai.schedule.Schedule getCurrentSchedule() {
        return ChipUtil1_16_R2.fromNMS(nmsMob.getBehaviorController().getSchedule());
    }

    @Override
    public void setSchedule(@NotNull me.gamercoder215.mobchip.ai.schedule.Schedule s) {
        nmsMob.getBehaviorController().setSchedule(ChipUtil1_16_R2.toNMS(s));
    }
    ...
    public void setDefaultActivity(@NotNull Activity a) {
        nmsMob.getBehaviorController().b(ChipUtil1_16_R2.toNMS(a));
    }
    ...
    public void setRunningActivity(@NotNull Activity a) {
        nmsMob.getBehaviorController().a(ChipUtil1_16_R2.toNMS(a));
    }

    @Override
    public @Nullable Activity getRunningActivity() {
        return nmsMob.getBehaviorController().f().isPresent() ? ChipUtil1_16_R2.fromNMS(nmsMob.getBehaviorController().f().get()) : null;
    }

    @Override
    public boolean isRunning(@NotNull Activity a) {
        return nmsMob.getBehaviorController().c(ChipUtil1_16_R2.toNMS(a));
    }
    ...
    public Consumer<Mob> put(@NotNull Activity key, Consumer<Mob> value) {
        nmsMob.getBehaviorController().a(ChipUtil1_16_R2.toNMS(key), 0, ImmutableList.of(ChipUtil1_16_R2.toNMS(value)));
        return value;
    }
