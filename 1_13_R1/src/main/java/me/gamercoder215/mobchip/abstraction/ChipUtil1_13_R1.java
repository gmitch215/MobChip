...
public class ChipUtil1_13_R1 implements ChipUtil {
    ...
    private static net.minecraft.server.v1_13_R1.ItemStack toNMS(org.bukkit.inventory.ItemStack i) {
    ...
    private static PathfinderGoal toNMS(Pathfinder b) {
        ...
        switch (b.getInternalName()) {
            ...
            case "FishSchool": {
                ...
                g = new PathfinderGoalFishSchool((EntityFish) m);
                break;
            }
            case "FleeSun": {
    ...
    private static org.bukkit.World fromNMS(net.minecraft.server.v1_13_R1.World l) { return l.getWorld(); }
    ...
    private Pathfinder fromNMS(PathfinderGoal g) {
        ...
        if (name.startsWith("PathfinderGoal")) {
            ...
            switch (name) {
                ...
                case "UseItem": return new PathfinderUseItem(m, fromNMS(getObject(g, "b", net.minecraft.server.v1_13_R1.ItemStack.class)), en -> getObject(g, "c", Predicate.class).test(toNMS(en)), fromNMS(getObject(g, "d", SoundEffect.class)));
