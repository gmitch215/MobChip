...
public final class DragonPhase1_13_R1 implements DragonPhase {

    private final EnderDragon dragon;
    private final IDragonController handle;

    public DragonPhase1_13_R1(EnderDragon dragon, IDragonController handle) {
        this.dragon = dragon;
        this.handle = handle;
    }
    ...
    public @NotNull Location getTargetLocation() {
        return ChipUtil1_13_R1.fromNMS(handle.g(), dragon.getWorld());
    }
