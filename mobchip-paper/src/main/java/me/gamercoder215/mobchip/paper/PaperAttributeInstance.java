...
final class PaperAttributeInstance implements ChipAttributeInstance {

	private final net.minecraft.world.entity.ai.attributes.AttributeInstance nms;
	private final Attribute a;
	
	PaperAttributeInstance(Attribute a, net.minecraft.world.entity.ai.attributes.AttributeInstance nms) {
		this.nms = nms;
		this.a = a;
	}
